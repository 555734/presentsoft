...
city().then(()=>{loading.style.display='none';setTimeout(()=>hint.style.opacity='0',3500)}).catch(e=>{console.error(e);loading.textContent='読み込みに失敗しました';loading.style.background='rgba(120,0,0,.72)'});
